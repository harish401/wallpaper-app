  ...
  _renderItemCatogories = ({ item, index }) => {
    return (
      <TouchableOpacity
        ...
        onPress={() =>
          this.props.navigation.navigate("FullCatogery", { query: item.title })
        }
      >
        <ImageBackground
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={{ height: "100%", width: "100%" }}>
          <ImageBackground
            source={{
              uri: "https://images.pexels.com/photos/440731/pexels-photo-440731.jpeg?auto=compress&cs=tinysrgb&w=1600",
            }}
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  onPress={() =>
                    this.props.navigation.navigate("FullCatogery", {
                      query: this.state.searchQuery,
                    })
                  }
                >
                  <Icon name="search1" color="black" size={15} />
                </TouchableOpacity>
              </Animated.View>
            </View>
          </ImageBackground>
          ...
          <TouchableOpacity
            onPress={() => this.props.navigation.navigate("Browser")}
